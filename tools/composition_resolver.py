#!/usr/bin/env python3
"""Deterministic cold-path package/profile resolver for Helve compositions."""
...
def _arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--lock", type=Path, default=Path("Helve.lock"))
    parser.add_argument(
        "--crate", type=Path, default=Path("crates/helve-composition")
    )
