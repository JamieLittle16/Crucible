...
const BLOCK_STATE_COUNT_U32: u32 = {state_count};
...
mod tests {{
    ...
    fn generated_identity_bounds_hold() {{
        ...
        assert!(BlockStateId::new(BLOCK_STATE_COUNT_U32 - 1).is_some());
        assert!(BlockStateId::new(BLOCK_STATE_COUNT_U32).is_none());
        assert_eq!(STATE_MUTATION_FLAGS.len(), BLOCK_STATE_COUNT);
    }}

    #[test]
    fn external_identity_round_trip_is_exact() {{
        for raw in 0..BLOCK_STATE_COUNT_U32 {{
