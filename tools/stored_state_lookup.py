...
pub(crate) const STORED_STATE_LOOKUP_INPUT_SHA256: &str = "{result['state_data_input_sha256']}";
pub(crate) const STORED_STATE_LOOKUP_BINARY_SHA256: &str = "{result['binary_sha256']}";
