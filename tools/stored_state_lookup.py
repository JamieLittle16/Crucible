...
def _render_rust(result: dict[str, object]) -> str:
    ...
    def rust_number(value: object) -> str:
        if not isinstance(value, int):
            raise ValueError("generated Rust numeric value must be an integer")
        return f"{value:_}"
...
pub(crate) const STORED_STATE_LOOKUP_BYTES: usize = {rust_number(result['binary_bytes'])};
pub(crate) const STORED_STATE_LOOKUP_COUNT: usize = {rust_number(result['state_count'])};
pub(crate) const STORED_STATE_BUCKET_COUNT: usize = {rust_number(bucket_count)};
pub(crate) const STORED_STATE_BUCKET_MASK: u64 = {rust_number(bucket_count - 1)};
pub(crate) const STORED_STATE_SLOT_COUNT: usize = {rust_number(slot_count)};
pub(crate) const STORED_STATE_SLOT_MASK: u64 = {rust_number(slot_count - 1)};
pub(crate) const STORED_STATE_NAME_COUNT: usize = {rust_number(result['name_count'])};
pub(crate) const STORED_STATE_PROPERTY_PAIR_COUNT: usize = {rust_number(result['property_pair_count'])};
pub(crate) const STORED_STATE_PROPERTY_OCCURRENCES: usize = {rust_number(result['property_occurrences'])};
pub(crate) const STORED_STATE_MAX_PROPERTIES: usize = {rust_number(result['max_properties_per_state'])};
pub(crate) const STORED_STATE_DISPLACEMENTS_OFFSET: usize = {rust_number(offset('displacements'))};
pub(crate) const STORED_STATE_SLOTS_OFFSET: usize = {rust_number(offset('slots'))};
pub(crate) const STORED_STATE_DESCRIPTORS_OFFSET: usize = {rust_number(offset('state_descriptors'))};
pub(crate) const STORED_STATE_PROPERTY_IDS_OFFSET: usize = {rust_number(offset('property_ids'))};
pub(crate) const STORED_STATE_NAME_INDEX_OFFSET: usize = {rust_number(offset('name_index'))};
pub(crate) const STORED_STATE_PAIR_INDEX_OFFSET: usize = {rust_number(offset('pair_index'))};
pub(crate) const STORED_STATE_NAME_BLOB_OFFSET: usize = {rust_number(offset('name_blob'))};
pub(crate) const STORED_STATE_PAIR_BLOB_OFFSET: usize = {rust_number(offset('pair_blob'))};
