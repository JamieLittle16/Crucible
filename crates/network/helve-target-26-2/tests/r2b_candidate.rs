...
//!
//! R2B is compiled exactly once by `helve-target-26-2`. These tiny compatibility namespaces keep
...
pub use helve_target_26_2::r2b;

pub mod r2b_border {
    pub use helve_target_26_2::r2b::WorldBorderPayload;
}

pub mod r2b_clock {
    pub use helve_target_26_2::r2b::{ClockFullSyncPayload, ClockUpdate};
}

pub mod r2b_difficulty {
    pub use helve_target_26_2::r2b::{ChangeDifficultyPayload, Difficulty26_2};
}
...
pub mod r2b_inventory {
    pub use helve_target_26_2::r2b::FreshEmptyInventoryPayload;
}
...
pub mod r2b_plan {
    pub use helve_target_26_2::r2b::{PreparedLookup, PreparedR2bPlan};
}

pub mod r2b_player_info {
    pub use helve_target_26_2::r2b::InitialPlayerInfoEntry;
}
...
pub mod r2b_recipe {
    pub use helve_target_26_2::r2b::{RecipeBookSettingFlags, RecipeBookSettingsPayload};
}

pub mod r2b_spawn {
    pub use helve_target_26_2::r2b::DefaultSpawnPayload;
}

pub mod r2b_teleport {
    pub use helve_target_26_2::r2b::TeleportTransaction;
}
